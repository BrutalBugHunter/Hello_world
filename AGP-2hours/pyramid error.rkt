...
(define (outputwindow1 p)
  (define x (make-object font% 70.0
              'default))
              ;['style 'bold]))
;  (define list-of-vertices (vector->list p))
...
;                                                  (show-coordinates dc listofver1 0)))))))
  ...
  (define list-nodes (vector->list p))
